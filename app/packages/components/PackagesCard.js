  ...
  return (
    <article className="group flex flex-col overflow-hidden border border-transparent bg-transparent transition-all duration-300 hover:border-black">
      ...
      <div className="flex flex-col justify-between gap-2 px-2 py-2 md:py-3">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center border border-black bg-[var(--primary)] px-4 py-4 text-sm font-semibold text-white no-underline transition-colors duration-200 hover:bg-[var(--secondary)] hover:text-black"
        >
